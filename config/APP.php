<?php
	...
	const FACEBOOK="https://www.facebook.com/LibrosOnline/";
	const INSTAGRAM="";
	const YOUTUBE="https://www.youtube.com/c/LibrosOnline/";
	const TWITTER="";


	/*----------  Direccion - Address  ----------*/
	const COUNTRY="Ecuador";
	const ADDRESS="Quito, Ecuador";
