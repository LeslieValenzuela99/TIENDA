...
<div class="bg-white full-box">
    <div class="container container-web-page">
        ...
        <p class="text-justify">Bienvenido al menú de productos, aquí se encuentran todos los productos disponibles en nuestra tienda. Puede ordenar los productos por categoría en el botón "<i class="fas fa-tags fa-fw"></i> CATEGORÍAS" y también ordenarlos por orden alfabético o por precio en el botón "<i class="fas fa-sort-alpha-down fa-fw"></i> ORDENAR POR". Además, puede buscar productos por nombre haciendo clic en el botón "<i class="fas fa-search fa-fw"></i> &nbsp; BUSCAR"</p>
        <?php } ?>
